        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header">
                    <h1 class="display-4 bg-primary text-white text-center">Employee Salary Search</h1>
                </div>
                <div class="card-body">
                    <form method="post" action="salarySearchServlet">
                        ...
                        <div class="form-group mt-3">
                            <div class="text-center">
                                <input type="submit" value="Employee Salary Details" class="btn btn-lg btn-success"/>
                            </div>
                        </div>
                    </form>
                </div>
